...
async function persistProfile(userId: string, input: OnboardingInput) {
    ...
    const profileData = {
        ...
        preparationProfile: input.preparationProfile ?? null,
        weekdayStudyMinutes: input.weekdayStudyMinutes ?? null,
        weekendStudyMinutes: input.weekendStudyMinutes ?? null,
        optionalSubject: input.optionalSubject ?? null,
