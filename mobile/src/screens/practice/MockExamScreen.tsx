...
function formatNegative(t: Translate, scoring: MockScoring): string { return scoring.negativeMarking.kind === 'FIXED_MARKS' ? interpolate(t('mockScreen.marks'), { count: scoring.negativeMarking.marks ?? 0 }) : scoring.negativeMarking.kind === 'FRACTION_OF_QUESTION_MARKS' ? interpolate(t('mockScreen.percentOfMarks'), { percent: Math.round((scoring.negativeMarking.fraction ?? 0) * 100) }) : t('mockScreen.none'); }
