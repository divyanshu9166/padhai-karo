...
import { createCommunityPost, getBuddies, getBuddyMatches, getCommunityMessages, getCommunityPosts, reportCommunityContent, requestBuddy, sendCommunityMessage, shareDashboard, updateBuddy, type BuddyMatch, type BuddyRequest, type CommunityMessage, type CommunityPost } from '@/api/upscProduct';
import { CommunitySocket } from '@/realtime/communitySocket';
import type { MoreStackScreenProps } from '@/navigation/types';

export function CommunityScreen({ navigation }: MoreStackScreenProps<'Community'>): React.JSX.Element {
